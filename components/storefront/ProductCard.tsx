...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-3xl border border-[#E9E1D2] hover:border-[#D62300]/40 overflow-hidden shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between group" data-testid={`product-${product.id}`}>
      <div>
